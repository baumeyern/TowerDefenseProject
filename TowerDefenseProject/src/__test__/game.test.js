...
jest.mock("../components/objects/Draggable", () => () => {
    const MockName = "draggable-mock";
    return <MockName />;
});
jest.mock("../components/objects/Panel", () => () => {
    const MockName = "panel-mock";
    return <MockName />;
});
...
jest.mock("../components/objects/audio", () => () => {
...
it("renders login page with header and buttons", () => {
    ...
    const wrapper = mount(<Router location={location}><GamePage/></Router>);
